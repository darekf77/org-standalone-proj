...
export class OrgStandaloneProjApp implements OnInit {
...
//#region  org-standalone-proj api service
...
//#region  org-standalone-proj routes
//#region @browser
...
//#region  org-standalone-proj app configs
//#region @browser
export const OrgStandaloneProjAppConfig: ApplicationConfig = {
  providers: [
    provideZonelessChangeDetection(),
    {
      provide: TAON_CONTEXT,
      useFactory: () => OrgStandaloneProjContext,
    },
    providePrimeNG({
      theme: {
        preset: Aura,
    ...
    }),
    {
      ...
      multi: true,
      useFactory: () => OrgStandaloneProjStartFunction,
    },
    provideBrowserGlobalErrorListeners(),
    // remove withHashLocation() to use SSR
    provideRouter(
      OrgStandaloneProjClientRoutes,
      withHashLocation(),
      withComponentInputBinding(),
    ),
...
export const OrgStandaloneProjServerConfig: ApplicationConfig = {
  providers: [
    provideServerRendering(withRoutes(OrgStandaloneProjServerRoutes)),
  ],
};

export const OrgStandaloneProjConfig = mergeApplicationConfig(
  OrgStandaloneProjAppConfig,
  OrgStandaloneProjServerConfig,
);
//#endregion
//#endregion
...
//#region  org-standalone-proj migration
...
//#region  org-standalone-proj start function
export const OrgStandaloneProjStartFunction = async (
  ...
  await OrgStandaloneProjContext.initialize();
...
export default OrgStandaloneProjStartFunction;
//#endregion
